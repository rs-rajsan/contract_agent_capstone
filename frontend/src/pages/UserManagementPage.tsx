              ...
              {selectedUserForEdit ? (
                ...
                <div className="p-20 flex flex-col items-center justify-center rounded-3xl bg-slate-50 dark:bg-slate-900/30 border-2 border-dashed border-slate-200 dark:border-slate-800">
                  ...
                  <button 
                    ...
                    className="mt-6 rounded-xl text-[10px] font-black uppercase tracking-widest px-6 py-2 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800"
                  >
                    Return to Directory
                  </button>
                </div>
